...
//   summary.parentElement.addEventListener('keyup', onKeyUpEscape);
  ...
  summary.addEventListener('mouseover', (event) => {
    const openDetailsElement = event.target.closest('details:not([open])');
    if (!openDetailsElement) return;

    const summaryElement = openDetailsElement.querySelector('summary');
    openDetailsElement.setAttribute('open', true);
...
/* Announcement bar */
document.querySelectorAll('.announcement-bar').forEach((announcement) => {
  
  announcement.addEventListener('click', (event) => {
    document.body.classList.add('page-popup__visible');
  });
});

document.querySelectorAll('.page-popup__close, .page-popup__bg').forEach((popupElement) => {
  
  popupElement.addEventListener('click', (event) => {
    document.body.classList.remove('page-popup__visible');
  });
});
/* /Announcement bar */
...
/* Comparison chart */
var comparisonChartRight = document.querySelector('.comparison-chart__right');
var comparisonChartBottom = document.querySelector('.comparison-chart__bottom');

if (comparisonChartRight && comparisonChartBottom) {
  comparisonChartRight.innerHTML = comparisonChartBottom.innerHTML;
}
/* /Comparison chart */